...
export async function GET(request: Request) {
  ...
  try {
    ...
    const nextWeekly = setTimeUtc(getNextWeeklyDateUtc(now, weeklyWeekday), hourUtc, minuteUtc);
    const nextMonthly = setTimeUtc(getNextMonthlyDateUtc(now, monthlyDay), hourUtc, minuteUtc);
